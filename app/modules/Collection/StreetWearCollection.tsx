...
const streetProducts: StreetProduct[] = [
  {
    id: 1,
  ...
  {
    id: 3,
    name: "Cargo Pants Outfit",
    price: "$55",
    image: "/img (23).png",
  },
  {
    id: 4,
    name: "Urban Sneaker Look",
    price: "$89",
    image: "/img (24).png",
  },
];

export default function StreetWearCollection() {
  return (
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-400">
            Explore modern street fashion designed for bold personalities who
            love confidence and unique style.
          </p>
        </div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mt-6 flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-500 line-through">$99</p>
